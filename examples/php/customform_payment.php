...
//    session_start();
    $_SESSION['CustomForm'] = true;
    
    include 'payler_class.php';
    include 'settings.php';
    echo '<table>';
    echo '<tr><th>Одностадийный платеж</th></tr>';
    ...
    */
    ...
    $template = 'paytemplatewithparams'; //  шаблон платежной формы. 
                                         //  Если вы хотите использовать собственную платежную формы - обратитесь в слежбу поддержки Пэйлер
    ...
    $data = array (                // Параметры, отмеченные в описании звездочкой (*), обязательны для заполнения
       ...
       */                          //  
                                   //  Например
        'pay_page_param_user' => 'Пункт 1212-2112',
        'pay_page_param_doc' => 'Рабочая заявка',
        'pay_page_param_1' => 'Спасибо за то, что выбрали нас',
