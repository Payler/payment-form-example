...
class plgVmPaymentPayler extends vmPSPlugin {
   ...
   function plgVmConfirmedOrder($cart, $order)
   {
      ...
      if(isset($session_data['session_id'])) {
          ...
          $html = $this->StartSessionError();
          vmError(JText::_('PLG_PAYLER_STARTSESSION_ERROR'));
          JRequest::setVar('html', $html);
       }
   ...
   function StartSessionError () {
      $result = '<html><head><title>Start payment error</title></head><body><div style="margin: auto; text-align: center;">'
         . '<form name="Start session error">'
         . JText::_('PLG_PAYLER_STARTSESSION_ERROR')
         . '</form></div></body></html>';
      return $result;
   }
   ...
   protected function checkConditions ($cart, $method, $cart_prices) {
      ...
      //vmdebug('Payler checkConditions',  $amount, $cart_prices['salesPrice'],  $cart_prices['salesPriceCoupon']);
   ...
   */
   ...
   function plgVmOnPaymentResponseReceived(&$html) {
      ...
      if($order_paid_success) {
         ...
         vmInfo(JText::_('PLG_PAYLER_PAYMENT_FAILED'));
