...
<body>
    ...
    echo '<table>';
    echo '<tr><th>Одностадийный платеж с загрузкой платежной формы в iframe</th></tr>';
    ...
    */
    ...
    if(isset($session_data['session_id'])) {
        ...
        Для оплаты заказа пользователь загружаем страницу в iframe 
        
        возврата необходимо вызвать GetStatus с параметрами - идентификатор заказа ($order_id) и идентификатор продавца ($key)
        */   
        $iframe_url = $payler->base_url.'Pay?session_id='.$session_id;
